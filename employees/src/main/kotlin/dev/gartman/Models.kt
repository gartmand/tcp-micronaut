...
data class Address(@BsonProperty @JsonProperty val line1: String?,
...
data class Bio(@BsonProperty @JsonProperty val firstName: String,
...
data class Contact(@BsonProperty @JsonProperty @field:Email val email: String,
                   @BsonProperty @JsonProperty val phoneNumber: String,
                   @field:Valid val address: Address)

data class Employee @BsonCreator @JsonCreator constructor(@BsonId @JsonProperty val id: ObjectId?,
